...
See the [TA-lib indicators](https://gekko.wizb.it/docs/strategies/talib_indicators.html) document for a list of all suppported TA-lib indicators and there required parameters.
